  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-4">Responsible Gaming Policy</h1>
        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                <h3 className="text-sm font-semibold mb-2">1.1. Minimum Age Requirement</h3>
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">1.2. Our Age Verification Process</h3>
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">1.3. Consequences of Underage Play</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">1.4. Player Responsibilities</h3>
                <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                <h3 className="text-sm font-semibold mb-2">2.1. Objectives</h3>
                <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">2.2. Tips for Players</h3>
                <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">3.1. Self-Exclusion & Account Closure</h3>
                <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">3.2. Limit Setting</h3>
                <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">3.3. Accessing These Options</h3>
                <p className="text-sm text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                <h3 className="text-sm font-semibold mb-2">4.1. Legal Compliance</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">4.2. Obligation to Obey Local Laws</h3>
                <p className="text-sm text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                <h3 className="text-sm font-semibold mb-2">5.1. Professional Resources</h3>
                <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
                  <li>
                    <strong>National Council on Problem Gambling:</strong>{' '}
                    <a href="https://www.ncpgambling.org" target="_blank" rel="noopener noreferrer" className="text-sm text-[#D4AF37] hover:underline">
                      www.ncpgambling.org
                    </a>
                    {' | '}1-800-522-4700
                  </li>
                  <li>
                    ...
                    <a href="https://www.responsiblegambling.org" target="_blank" rel="noopener noreferrer" className="text-sm text-[#D4AF37] hover:underline">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">5.2. Self-Assessment</h3>
                <p className="text-sm text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                <h3 className="text-sm font-semibold mb-2">7.1. Account Security</h3>
                <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2">7.2. Device Security</h3>
                <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
