  ...
  return (
    <div className="space-y-4 p-4 max-w-md mx-auto">
      ...
      <div className="text-center mb-6">
        ...
        <h3 className="text-2xl font-bold text-white mb-2" data-testid="text-free-topup">
          Free Play Top Up
        </h3>
      ...
      {/* Reward Display */}
      <div className="bg-[#1a1a1a] rounded-lg p-6 mb-4 text-center border border-gray-700">
        <div className="text-4xl font-bold text-yellow-400 mb-2">
          {gcAmount.toLocaleString()}
        </div>
        <div className="text-lg text-gray-300 mb-3">Gold Coins</div>
      ...
      {/* Countdown Timer */}
      {!canClaim && countdown && (
        <div className="bg-[#1a1a1a] rounded-lg p-4 text-center mb-4 border border-gray-700">
          <div className="text-base text-gray-200">{countdown}</div>
        </div>
      )}
      ...
      {canClaim ? (
        <Button
          ...
          className="w-full bg-gradient-to-b from-yellow-600 to-orange-500 hover:from-yellow-700 hover:to-orange-600 text-black font-bold py-4 text-lg h-14 touch-friendly-button shadow-md hover:shadow-lg transition-all"
        ...
        <Button
          disabled
          className="w-full bg-gray-700 text-gray-400 font-bold py-4 cursor-not-allowed text-lg h-14"
      ...
      {/* Info */}
      <div className="bg-[#1a1a1a] rounded-lg p-4 mt-4 border border-gray-700">
        <div className="flex items-start gap-3">
          <AlertCircle className="w-6 h-6 text-blue-400 mt-0.5 flex-shrink-0" />
          <div className="text-left text-sm text-gray-200">
            <p className="mb-2">• Completely free - no purchase required</p>
            <p className="mb-2">• Available every 6 hours</p>
      ...
      <AnimatePresence>
        {showClaimPopup && claimData && (
          ...
          >
            <motion.div 
              className="bg-gradient-to-br from-yellow-500 to-orange-600 rounded-xl p-8 mx-4 shadow-2xl border border-yellow-400/30 pointer-events-auto"
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-black mb-2" data-testid="text-award-topup">
                  Free Top Up Claimed!
                </h3>
...
function DailyStreakComponent() {
  ...
  return (
    <div className="space-y-4 p-4 max-w-md mx-auto">
      ...
      <div className="text-center mb-6">
        <div className="relative inline-block mb-4">
          <div className="w-20 h-20 bg-gradient-to-br from-yellow-600 to-orange-700 rounded-lg flex items-center justify-center transform rotate-3 shadow-lg">
            <div className="text-4xl">💰</div>
          </div>
          {canClaim && (
            <div className="absolute -top-1 -right-1 w-4 h-4 bg-green-500 rounded-full animate-pulse"></div>
        ...
        <h3 className="text-2xl font-bold text-white mb-2" data-testid="text-streak">
      ...
      {/* 7-Day Calendar Grid */}
      <div className="bg-[#1a1a1a] rounded-lg p-5 mb-4 border border-gray-700">
        <div className="grid grid-cols-4 gap-3 mb-4">
          {rewardsWithClaimed.slice(0, 4).map((reward) => (
            <div key={reward.day} className="text-center" data-testid={`cell-day-${reward.day}`}>
              ...
              <div className="text-base font-medium text-white mb-2">{reward.day}</div>
              <div className={`w-14 h-14 mx-auto rounded-full border-2 flex items-center justify-center mb-2 ${
                reward.claimed 
              ...
              <div className="text-xs text-gray-200" data-testid={`text-gc-${reward.day}`}>
                GC {reward.goldCoins.toLocaleString()}
              </div>
              <div className="text-xs text-gray-200" data-testid={`text-sc-${reward.day}`}>
      ...
      {canClaim ? (
        <Button
          onClick={() => claimMutation.mutate()}
          disabled={claimMutation.isPending}
          className="w-full bg-gradient-to-b from-green-700 to-green-500 hover:from-green-800 hover:to-green-600 text-white font-bold py-4 text-lg h-14 touch-friendly-button shadow-md hover:shadow-lg transition-all"
      ...
      <div className="bg-[#1a1a1a] rounded-lg p-4 mt-4 border border-gray-700">
        <div className="flex items-start gap-3">
          <AlertCircle className="w-6 h-6 text-blue-400 mt-0.5 flex-shrink-0" />
          <div className="text-left text-sm text-gray-200">
            <p className="mb-2">• Login daily to maintain your streak</p>
            <p className="mb-2">• Rewards increase with streak length</p>
      ...
      <AnimatePresence>
        {showClaimPopup && claimData && (
          ...
          >
            <motion.div 
              className="bg-gradient-to-br from-green-600 to-green-700 rounded-xl p-8 mx-4 shadow-2xl border border-green-500/30 pointer-events-auto"
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.8 }}
            >
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2" data-testid="text-award">
                  Daily Bonus Claimed!
                </h3>
...
function RedeemSweepsCashComponent() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Sparkling Icon */}
      <div className="text-center">
        <div className="relative inline-flex items-center justify-center w-24 h-24 rounded-full bg-green-500/20 border-2 border-green-500/30 mb-4">
          <div className="w-14 h-14 rounded-full bg-green-500 flex items-center justify-center">
            <Star className="w-8 h-8 text-white fill-current" />
          </div>
          {/* Sparkle effects */}
          <Star className="w-4 h-4 text-green-400 absolute -top-1 -right-1 fill-current" />
          <Star className="w-3 h-3 text-green-400 absolute top-2 -left-2 fill-current" />
          <Star className="w-3 h-3 text-green-400 absolute -bottom-1 left-3 fill-current" />
        </div>
      </div>
      ...
      {/* Balance Display */}
      <div className="bg-[#1a1a1a] rounded-lg p-5 space-y-4 border border-gray-700">
        <div className="flex items-center justify-between">
          <span className="text-gray-300 text-base">Total balance</span>
          <div className="flex items-center gap-2">
            <Shield className="w-5 h-5 text-green-400" />
            <span className="text-green-400 font-medium text-lg">{sweepsTotal.toFixed(2)}</span>
          </div>
        </div>
        
        <div className="flex items-center justify-between">
          <span className="text-gray-300 text-base">Redeemable balance</span>
          <div className="flex items-center gap-2">
            <Shield className="w-5 h-5 text-green-400" />
            <span className="text-green-400 font-medium text-lg">{sweepsRedeemable.toFixed(2)}</span>
          </div>
        </div>
      </div>
      ...
      <Button
        ...
        className="w-full h-14 text-lg font-medium bg-gray-500 hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
...
export default function PurchasePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col">
      {/* Header with Title */}
      <div className="flex items-center justify-center p-4 border-b border-[#1a1a1a] flex-shrink-0">
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab} className="flex-1 flex flex-col">
          ...
          <TabsList className="grid w-full grid-cols-4 bg-gradient-to-r from-[#0f0f0f] to-[#1a1a1a] border-b border-[#2a2a2a] rounded-none h-auto gap-[1px]">
            ...
            >
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-xs whitespace-nowrap">Redeem</span>
              </div>
            </TabsTrigger>
            <TabsTrigger 
              value="daily" 
            ...
            >
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-xs whitespace-nowrap">Top Up</span>
              </div>
            </TabsTrigger>
          </TabsList>
        </div>
        ...
        <div className="flex-1 overflow-y-auto purchase-modal-content min-h-0" style={{
          ...
          <TabsContent value="buy" className="p-4 md:p-6 space-y-4 md:space-y-6">
            {/* Daily Purchase Limit */}
            <div className="bg-[#1a1a1a] rounded-lg p-4 md:p-5 flex items-center justify-between mobile-spacing border border-gray-700">
              <div className="flex items-center gap-2 md:gap-3">
                <span className="text-base text-gray-300">Daily limit is</span>
                <span className="text-green-400 font-semibold text-lg">${formatCoins(dailyRemaining)}.00</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4 pb-4 max-h-[60vh] overflow-y-auto" style={{
              scrollbarWidth: 'thin',
              ...
              {PACKAGES.map((pkg) => (
                ...
                >
                  {pkg.popular && (
                    <div className="absolute top-0 right-0 bg-gradient-to-b from-purple-700 to-purple-500 text-white text-xs px-3 py-1.5 rounded-bl-lg shadow-lg">
                  ...
                  <div className="p-4 md:p-5 text-center">
                    ...
                    <div className="text-base md:text-lg text-green-400 font-semibold mb-2">
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-b from-purple-700 to-purple-500 hover:from-purple-800 hover:to-purple-600 text-white text-sm md:text-base h-10 md:h-12 touch-friendly-button shadow-md hover:shadow-lg transition-all"
                    >
          ...
          <TabsContent value="redeem" className="p-4 md:p-6">
            <RedeemSweepsCashComponent />
          </TabsContent>

          <TabsContent value="daily" className="p-4 md:p-6">
            <DailyStreakComponent />
          </TabsContent>

          <TabsContent value="topup" className="p-4 md:p-6 space-y-6">
            <FreeTopUpComponent />
          </TabsContent>
        </div>
      </Tabs>
