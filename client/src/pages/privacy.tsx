      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            >
              <Download className="w-5 h-5 mr-0.5" />
              Download
            </Button>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="prose prose-sm max-w-none dark:prose-invert">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">2. SCOPE</h2>
            <h3 className="text-base font-semibold mt-4 mb-2">Applicability</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Policy Updates</h3>
            <p className="text-sm">
            ...
            <p className="text-sm">We may collect various types of information, including but not limited to:</p>
            <h3 className="text-base font-semibold mt-4 mb-2">Personal Information</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Non-Personal Information</h3>
            <p className="text-sm">
            ...
            <p className="text-sm">The ways we use your information include, but are not limited to:</p>
            <h3 className="text-base font-semibold mt-4 mb-2">Account Creation & Management</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Service Provision</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Communication</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Marketing & Promotions</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Analytics & Improvements</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Legal & Compliance</h3>
            <p className="text-sm">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">5. NO SHARING OF MOBILE INFORMATION WITH THIRD PARTIES</h2>
            <h3 className="text-base font-semibold mt-4 mb-2">Mobile Phone Number</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Mobile Device Data</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Exceptions</h3>
            <p className="text-sm">We will only disclose mobile-related information if it is necessary:</p>
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">6. HOW WE SHARE YOUR INFORMATION</h2>
            <p className="text-sm">Aside from the mobile information restrictions set forth in Section 5, we may share your personal information in the following ways:</p>
            <h3 className="text-base font-semibold mt-4 mb-2">Service Providers</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Business Transfers</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Legal Requirements</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Technical Measures</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Access Controls</h3>
            <p className="text-sm">
              We limit access to personal information to authorized personnel who need such access to perform their job functions.
            </p>
            <h3 className="text-base font-semibold mt-4 mb-2">No Absolute Guarantee</h3>
            <p className="text-sm">
              While we strive to protect your personal information, no security system is 100% infallible. We cannot guarantee the 
              absolute security of your data.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-3">8. COOKIES & TRACKING TECHNOLOGIES</h2>
            <p className="text-sm">We and our partners may use cookies, web beacons, and similar technologies to:</p>
            <ul className="text-sm">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">9. YOUR CHOICES & RIGHTS</h2>
            <h3 className="text-base font-semibold mt-4 mb-2">Opt-Out of Marketing</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">Account Management</h3>
            <p className="text-sm">
              You may review, update, or correct your account information by logging into your account or contacting us.
            </p>
            <h3 className="text-base font-semibold mt-4 mb-2">Data Access & Deletion</h3>
            <p className="text-sm">
            ...
            <h3 className="text-base font-semibold mt-4 mb-2">DNSMPI (Do Not Sell My Personal Information)</h3>
            <ul className="text-sm">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">11. INTERNATIONAL USERS</h2>
            <p className="text-sm">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">12. RETENTION</h2>
            <p className="text-sm">
            ...
            <p className="text-sm">If you have any questions, concerns, or requests regarding this Privacy Policy or our data practices, please reach out:</p>
            <p className="text-sm">
