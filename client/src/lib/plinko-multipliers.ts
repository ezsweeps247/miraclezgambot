// Plinko multiplier configurations based on row count and risk level
export const PLINKO_MULTIPLIERS: Record<number, Record<string, number[]>> = {
  ...
  13: {
    ...
    high: [284, 33, 11, 4, 2, 1.1, 0.6, 0.3, 0.6, 1.1, 2, 4, 11, 33, 284]
  },
  14: {
    low: [7.1, 4, 2, 1.4, 1.1, 1, 0.5, 0.5, 1, 1.1, 1.4, 2, 4, 7.1],
    medium: [58, 15, 7, 4, 1.9, 1, 0.5, 0.2, 0.5, 1, 1.9, 4, 7, 15, 58],
    high: [420, 56, 18, 5, 1.9, 0.6, 0.3, 0.2, 0.3, 0.6, 1.9, 5, 18, 56, 420]
  },
  15: {
    low: [15, 8, 3, 2, 1.5, 1.1, 1, 0.5, 1, 1.1, 1.5, 2, 3, 8, 15],
    medium: [88, 18, 11, 5, 3, 1.3, 0.5, 0.3, 0.5, 1.3, 3, 5, 11, 18, 88],
    high: [620, 83, 27, 8, 3, 0.9, 0.2, 0.2, 0.2, 0.9, 3, 8, 27, 83, 620]
  },
  16: {
