      ...
      <div className="container mx-auto max-w-4xl">
        <div className="mb-8 pt-8">
          <Button
            ...
            size="lg"
            onClick={() => setLocation('/')}
            className="mb-4 border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black transition-colors"
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <Gift style={{width: '3.5px', height: '3.5px'}} className="text-golden mr-3" />
              <h1 className="text-[10px] font-bold text-white">Redeem Code</h1>
            </div>
            <p className="text-gray-400 text-[10px] max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white">Enter Redemption Code</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              {!redemptionResult && (
                <form onSubmit={handleRedeem} className="space-y-6">
                  <div>
                    <Label htmlFor="redemption-code" className="text-white">Redemption Code</Label>
                    <Input
                      id="redemption-code"
                      value={code}
                      onChange={(e) => setCode(e.target.value.toUpperCase())}
                      placeholder="Enter your code here"
                      className="bg-gray-700 border-gray-600 text-white mt-2 font-mono text-[10px]"
                  ...
                  <Button 
                    type="submit"
                    className="w-full bg-golden hover:bg-golden/90 text-black py-3 text-[10px] font-semibold"
                    disabled={redeemMutation.isPending || !code.trim()}
                    data-testid="button-redeem-code"
                  >
                    {redeemMutation.isPending ? (
                      <>
                        <Loader style={{width: '3px', height: '3px'}} className="mr-2 animate-spin" />
                        Redeeming...
                      </>
                    ) : (
                      <>
                        <Gift style={{width: '3px', height: '3px'}} className="mr-2" />
                        Redeem Code
                      </>
                    )}
                  </Button>
              ...
              {redemptionResult?.success && (
                <div className="text-center space-y-4">
                  ...
                  <div>
                    <h3 className="text-[10px] font-bold text-white mb-2">Code Redeemed Successfully!</h3>
                    <p className="text-gray-300 mb-4">{redemptionResult.message}</p>
                    
                    {redemptionResult.rewards && (
                      <div className="bg-gray-700 rounded-lg p-4 space-y-2">
                        <h4 className="font-semibold text-white mb-2">Rewards Received:</h4>
                        {redemptionResult.rewards.gcCredited && (
                          <div className="flex justify-between items-center">
                            <span className="text-gray-300">Gold Credits:</span>
                        ...
                        {redemptionResult.rewards.scCredited && (
                          <div className="flex justify-between items-center">
                            <span className="text-gray-300">Sweeps Cash:</span>
                        ...
                        {redemptionResult.rewards.bonusCreated && (
                          <div className="flex justify-between items-center">
                            <span className="text-gray-300">Bonus Created:</span>
              ...
              {redemptionResult && !redemptionResult.success && (
                <div className="text-center space-y-4">
                  <Alert className="border-red-500/50 bg-red-500/10">
                    <AlertCircle className=" text-red-400"style={{width: '3px', height: '3px'}} />
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white">How Redemption Codes Work</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-300">
              <div>
                <h4 className="font-semibold text-white mb-2">What are Redemption Codes?</h4>
              ...
              <div>
                <h4 className="font-semibold text-white mb-2">Types of Rewards</h4>
                <ul className="text-[8px] space-y-1">
                  <li className="flex items-center">
                    <div style={{width: '2.5px', height: '2.5px'}} className="bg-golden rounded-full mr-2"></div>
                    <span><strong className="text-golden">Gold Credits (GC)</strong> - For playing games</span>
                  </li>
                  <li className="flex items-center">
                    <div style={{width: '2.5px', height: '2.5px'}} className="bg-purple-400 rounded-full mr-2"></div>
                    <span><strong className="text-purple-400">Sweeps Cash (SC)</strong> - Can be redeemed for prizes</span>
                  </li>
                  <li className="flex items-center">
                    <div style={{width: '2.5px', height: '2.5px'}} className="bg-green-400 rounded-full mr-2"></div>
              ...
              <div>
                <h4 className="font-semibold text-white mb-2">Where to Find Codes</h4>
                <ul className="text-[8px] space-y-1">
