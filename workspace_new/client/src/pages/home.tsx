    ...
    <div className="w-full pb-16">
      ...
      >
          ...
          {banners.map((banner, index) => (
            ...
            >
              ...
              <div className="absolute top-2 left-2">
                <div className="bg-black/50 backdrop-blur text-white px-2 py-1 rounded-full text-[10px] font-semibold border border-white/20">
                  ✨ {banner.badge}
                </div>
              </div>
              ...
              <div className="relative h-full flex flex-col items-center justify-center text-white px-4 py-8 pt-[12px] pb-[12px] ml-[0px] mr-[0px] pl-[8px] pr-[8px] font-bold text-center mt-[0px] mb-[0px]">
                <div className="flex items-center gap-2 mb-3">
                  <h1 className="font-bold tracking-tight text-center whitespace-pre-line text-[13px]">
                    Try out our Free to play skill based Game!
                  </h1>
                </div>
                <p className="opacity-90 mb-4 text-center max-w-md text-[13px]">
                  {banner.subtitle}
                </p>
                  ...
                  {banner.buttons.map((button, btnIndex) => {
                    ...
                    return (
                      <Button
                        ...
                        className={`${getBannerButtonStyles(banner.id, button.variant || 'primary')} h-12 text-[12px] font-bold transform hover:scale-105 active:scale-95`}
              ...
              <div className="absolute bottom-2 left-2">
                <Star className="w-4 h-4 text-yellow-300 animate-pulse" style={{animationDelay: '0.5s'}} />
              </div>
        ...
        {currentBannerIndex === 0 && (
          <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 bg-black/60 backdrop-blur-sm text-white px-3 py-1.5 rounded-full text-[8px] font-medium animate-pulse">
            <span className="flex items-center gap-1">
              👆 Swipe to explore
              <div className="flex gap-0.5">
                <div className="w-[1px] h-[1px] bg-white/60 rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
                <div className="w-[1px] h-[1px] bg-white/60 rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
                <div className="w-[1px] h-[1px] bg-white/60 rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
              </div>
            </span>
          </div>
        )}
      ...
      <section className="py-0.5 mt-2 text-[12px]">
        <div className="bg-black/40 backdrop-blur-sm border-t border-b border-gray-800/30 p-2">
          <div className="flex items-center gap-1 px-2">
            <button
              onClick={() => setActiveCategory('all')}
              className={`flex-1 flex items-center justify-center h-10 rounded-lg transition-all whitespace-nowrap ${
                activeCategory === 'all'
            ...
            >
              <span className="font-semibold tracking-wide text-[12px]">Lobby</span>
            </button>
            ...
            >
              <span className="font-semibold tracking-wide text-[12px]">Originals</span>
            </button>
            ...
            >
              <span className="font-semibold tracking-wide text-[12px]">Slots</span>
            </button>
            ...
            >
              <span className="font-semibold tracking-wide text-[12px]">Free</span>
            </button>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className={`relative h-32 rounded-xl overflow-hidden border-2 ${game.borderColor}`}>
                ...
                {game.bgImage ? (
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${game.gradient}`}>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <game.icon className="w-16 h-16 md:w-20 md:h-20 text-white/20" />
                    </div>
                  </div>
                )}
                ...
                <div className="absolute top-0 left-0 right-0 p-1 z-10">
                  ...
                  <div className="flex justify-center mb-1">
                    <div className={`px-3 py-1 ${game.badgeColor} rounded-md flex items-center justify-center`}>
                      <span className="font-bold text-white tracking-wider text-[12px]">MIRACLEZ</span>
                    </div>
                  </div>
                  ...
                  <div className="px-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 translate-y-1 group-hover:translate-y-0 group-focus-within:translate-y-0 transition-all duration-200">
                    <p className="text-white/90 text-center mb-1.5 line-clamp-2 text-[12px]">
                      {game.description}
                    </p>
                    ...
                    <div className="flex justify-center">
                      <div className="bg-green-500/30 backdrop-blur-sm rounded-full px-3 py-1 border border-green-400/50 shadow-lg shadow-green-500/20">
                        <span className="font-bold text-green-300 text-[12px]">RTP: {game.rtp}%</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-2 z-10">
                  <h3 className="text-white font-black text-center tracking-wide drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)] uppercase text-[12px]">
                    {game.name}
                  </h3>
                </div>
      ...
      <section className="px-4 py-6 bg-[#0a0a0a] border-t border-gray-800">
        <h3 className="text-white text-center mb-6 text-[13px] font-bold">Smart Contract Wallet</h3>
